...
var bykire = rndom[Math.floor(Math.random() * rndom.length)]
   return new Promise( async (resolve, reject) => {
...
module.exports = { niatsholat, bacaanshalat, getDoujin, onGoing, kusoNime, mlstalk, ffstalk, npmstalk, quotesanime, pornovid, hentaivid, nomorhp, character, anime, manga, searchsticker, igstalk, listsurah, jadwalsholat, telesticker, aiovideodl, linkwa, mediafiredl, ytPlayMp4, ytPlayMp3, cerpen, getLatestAnime, getLatestKomik, AnimeDl, KomikDl, otakudesu, ttdownloader }